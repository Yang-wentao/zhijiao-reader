...
sbasic[title]="一、基础信息（Maxmind 数据库）"
sbasic[title_lite]="一、基础信息（IPinfo 数据库）"
sbasic[asn]="自治系统号：            "
sbasic[noasn]="未分配"
sbasic[org]="组织：                  "
sbasic[location]="坐标：                  "
...
sscore[medium]="中风险"
sscore[high]="高风险"
sscore[veryhigh]="极高风险"
sscore[elevated]="较高风险"
sscore[suspicious]="可疑IP"
sscore[risky]="存在风险"
sscore[highrisk]="高风险"
sscore[dos]="建议封禁"
sscore[colon]="："
sscore[title]="三、风险评分"
sscore[range]="$Font_Cyan风险等级：      极低         低       中等       高         极高$Font_Suffix"
...
smail[no]="阻断"
smail[occupied]="占用"
smail[blocked]="远端25端口不可达"
smail[provider]="通信："
smail[dnsbl]="IP地址黑名单数据库："
smail[available]="有效 "
smail[clean]="正常 "
smail[marked]="已标记 "
smail[blacklisted]="黑名单 "
