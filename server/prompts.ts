...
// Math + term-explanation formatting rules shared by translate and ask prompts.
// Keeping them in one constant lets us update both prompts in lockstep when
// markdown / KaTeX rendering edge cases come up.
